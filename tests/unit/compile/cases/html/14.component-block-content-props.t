...
---- CODE ----
('Lorem '.($runtime->createComponent('TestComponent',['foo'=>'42','bar'=>($runtime->param('lol'))],function()use($runtime){return ['ipsum <div/>',($runtime::htmlEncode(($runtime->param('dolor'))))];})).' sit')
---- RESULT ----
